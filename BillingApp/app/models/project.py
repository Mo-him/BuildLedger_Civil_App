...
class Project(Base):
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(UNIQUEIDENTIFIER, ForeignKey("USERS.id"), nullable=False)
    ...
    client_contact: Mapped[str | None] = mapped_column(String(30), nullable=True)
